...
export const DDStudioIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    // A simplified representation of the DD Studio logo.
    // A full SVG conversion from the provided PNG is not feasible without vector source files.
    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <circle cx="50" cy="50" r="48" fill="url(#dd-grad)" />
        <defs>
            <linearGradient id="dd-grad" x1="0" y1="0.5" x2="1" y2="0.5">
                <stop offset="0.5" stopColor="#3d9a9f" />
                <stop offset="0.5" stopColor="#c94a4f" />
            </linearGradient>
        </defs>
        <text x="50" y="65" fontFamily="Inter, sans-serif" fontSize="40" fill="white" textAnchor="middle" fontWeight="bold">DD</text>
    </svg>
);
...
export const BehanceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M22 6c0-1.104-.896-2-2-2H4c-1.104 0-2 .896-2 2v12c0 1.104.896 2 2 2h16c1.104 0 2-.896 2-2V6zM8.984 15.625H5.875v-4.812h3.109c1.47 0 2.305.814 2.305 2.408s-.835 2.404-2.305 2.404zm.297-5.906H5.875V8.375h3.406v1.344zm7.531 5.906h-4.312v-1.125h1.656c.55 0 .93-.25.93-.734V8.375h1.72v7.25z" />
        <path d="M12.938 10.938h-1.657v1.125h1.657c.55 0 .93.25.93.734s-.38.734-.93.734h-1.657v1.125h1.657c1.44 0 2.625-1.031 2.625-2.593s-1.185-2.594-2.625-2.594z" />
    </svg>
);
